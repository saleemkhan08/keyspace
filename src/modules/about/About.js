		...
		<section className='section section-lg bg-gradient-secondary'>
			<Container className='pt-lg pb-300'>
				<Row className='text-center justify-content-center'>
					<Col lg='10'>
						<h2 className='display-3 text-default'>Build something</h2>
				...
				<Row className='row-grid mt-5'>
					<Col lg='4'>
						...
						<h5 className='text-default mt-3'>Building tools</h5>
					...
					<Col lg='4'>
						...
						<h5 className='text-default mt-3'>Grow your market</h5>
						<p className='text-default mt-3'>
							Some quick example text to build on the card title and make up the
							bulk of the card's content.
						</p>
					...
					<Col lg='4'>
						...
						<h5 className='text-default mt-3'>Launch time</h5>
						<p className='text-default mt-3'>
							Some quick example text to build on the card title and make up the
							bulk of the card's content.
						</p>
